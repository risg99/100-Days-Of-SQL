-- 𝐌𝐮𝐬𝐭 𝐓𝐫𝐲: IBM(Hard Level) #SQL Interview Question — Solution
-- IBM is working on a new feature to analyze user purchasing behavior for all Fridays 
-- in the first quarter of the year. For each Friday separately, calculate the average amount
-- users have spent per order. The output should contain the week number of that Friday and
